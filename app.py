...
def create_app() -> Flask:
    ...
    def not_found(e):
        return render_template("error.html", code=404, message="This Echo doesn't exist."), 404

    @app.errorhandler(500)
    def server_error(e):
        return render_template("error.html", code=500, message="Something went wrong. The memory is foggy."), 500
